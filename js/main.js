...
$(function () {
    $('body').on('click', '.page-scroll a', function (event) {
        ...
        $('html, body').stop().animate({
            scrollTop: $( 'body' ).innerWidth() < 768 ? $($anchor.attr('href')).offset().top : $($anchor.attr('href')).offset().top - 40
        }, 1500, 'easeInOutExpo');
...
$(function () {
    $(".navbar-brand").append('<img src="img/sticky-header-logo.png" alt="" class="stickylogo" style="display: none">');
});
