!function(){for(var a,b=function(){},c=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],d=c.length,e=window.console=window.console||{};d--;)a=c[d],e[a]||(e[a]=b)}();var cbpAnimatedHeader=function(){function a(){$(".scroll-top a").hide(),window.addEventListener("scroll",function(a){f||(f=!0,setTimeout(b,250))},!1)}function b(){var a=c();$("body").innerWidth()<768&&a>=55||a>=g?e.removeClass("navbar-big"):e.addClass("navbar-big"),a>=h?$(".scroll-top a").fadeIn("slow"):$(".scroll-top a").fadeOut("slow"),f=!1}function c(){return window.pageYOffset||d.scrollTop}var d=document.documentElement,e=$(".navbar-fixed-top"),f=!1,g=110,h=300;a()}();/*!
