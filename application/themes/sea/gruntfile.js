        ...
        uglify: {
            ...
            main_files: {
                files: {
                    ...
                    'assets/js/contact_me.min.js': ['src/js/contact_me.js'],
...
//                banner: '\n/*! <%= grunt.template.today("dd-mm-yyyy") %> */\n',
        ...
        watch: {
            ...
            livereload: {
                ...
                files: ['*.{html,php}', '{elements}/*.{html,php}'],
            }
        }
    });
    ...
    // Default task(s).
    grunt.registerTask('default', ['fontello', 'less', 'copy', 'cssmin', 'concat', 'uglify', 'imagemin', 'modernizr']);
